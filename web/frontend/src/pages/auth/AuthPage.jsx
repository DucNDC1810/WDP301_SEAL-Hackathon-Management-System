...
import { Tabs, Form, Input, Button, message, ConfigProvider, theme } from 'antd';
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
        ...
        {particles.map((p, i) => (
          <span
            ...
            style={{
              ...
              width: p.size,
              height: p.size,
              animation: `authFloat ${p.duration} ${p.delay} infinite ease-in-out alternate`,
            }}
          />
        ))}
      </div>
      ...
      <div className="relative z-[2] w-full max-w-[440px] px-4">
        ...
        >
          <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-8 text-white">
            {/* Logo header */}
            <div className="text-center mb-6">
              <Link
                to="/"
                className="inline-flex items-center gap-2 no-underline text-white text-2xl font-bold"
              >
                    ...
                    <>
                      ...
                      <div className="flex justify-center mt-3">
                        <a
                          ...
                          className="inline-flex items-center gap-2 px-5 py-2 border border-white/20 rounded-lg text-white/80 text-sm no-underline transition-all hover:bg-white/10"
                        >
