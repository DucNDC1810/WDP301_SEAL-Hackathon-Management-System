...
async function seed() {
  ...
  const contest = await Contest.create({
    ...
    description: "Giải đấu dành riêng cho kiểm thử Leaderboard Sơ loại",
    status: "open",
    created_by: user._id,
  });
  ...
  // 4. Create 5 Teams
  const teamsData = [
    { name: "Đội Cyber Knights", group: "Bảng A", score: 9.2 },
    { name: "Đội Code Wizards", group: "Bảng A", score: 8.5 },
    { name: "Đội Dev Masters", group: "Bảng A", score: 9.7 },
    { name: "Đội Block Builders", group: "Bảng B", score: 8.0 },
    { name: "Đội Space Miners", group: "Bảng B", score: 9.5 }
  ];
